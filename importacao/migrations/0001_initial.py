    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='colaboradores', to='core.cargo')),
            ],
            options={
                'verbose_name': 'Colaborador',
                'verbose_name_plural': 'Colaboradores',
                'db_table': 'colaboradores',
                'indexes': [models.Index(fields=['email'], name='colaborador_email_03f0e5_idx'), models.Index(fields=['cargo'], name='colaborador_cargo_i_ec8419_idx')],
            },
        ),
    ]
